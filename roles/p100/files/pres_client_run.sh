...
while true; do
  java -Xmx1024m -cp "lib/*" org.icpc.tools.presentation.contest.internal.ClientLauncher https://10.3.3.207:9443/api/contests presentation xG4fBdyXzKsaWmshwFnsJLjQv8PwMLsJ --name team
  result=$?
